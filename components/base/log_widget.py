...
from ...constants import SHADOW_BLUR_RADIUS, LIGHT_GREEN
...
class LogWidget(QWidget):
    def __init__(self, on_close=None, parent=None, notification_types=None):
        super().__init__(parent=parent)

        self.notification_types = notification_types
        assert self.notification_types, "notification_types cannot be empty or None"
        assert hasattr(self.notification_types, 'ERROR'), 'ERROR must be in notification_types'
    ...
    def set_log(self, log):
        ...
        self.uid = log.uid
        if log.log_type == self.notification_types.ERROR:
