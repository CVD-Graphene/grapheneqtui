...
KeyboardStyle {
    ...
    readonly property real keyIconScale: scaleHint * 0.45 * 0.6
    readonly property real localScale: 0.6
        ...
        Rectangle {
            ...
            Text {
                ...
                font {
                    family: fontFamily
                    weight: Font.Normal
                    pixelSize: 38 * scaleHint * localScale
            ...
            Text {
                ...
                font {
                    family: fontFamily
                    weight: Font.Normal
                    pixelSize: 52 * scaleHint * localScale
                    capitalization: control.uppercased ? Font.AllUppercase : Font.MixedCase
                }
            }
        }
